...
class Countries
{
    ...
    public static function grouped_by_continent_regions ($selected = null) {
        return array(
            "Africa" => array(
                "DZ" => "Algeria",
                "AO" => "Angola",
    ...
    public static function grouped_by_sub_continent_regions ($selected = null) {
        return array(
    ...
    public static function ungroupedSelectOptions () {
